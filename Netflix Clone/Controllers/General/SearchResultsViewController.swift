...
class SearchResultsViewController: UIViewController {
    ...
    public var titles: [UpcomingMovie] = [UpcomingMovie]()
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        APICaller.shared.getMovie(with: titleName){ [weak self] results in
            ...
            case .success(let videoElement):
                self?.delegate?.searchResultsViewControllerDidTapItem(TitlePreviewViewModel(title: title.original_title ?? "Unkown", youtubeView: videoElement, titleOverview: title.overview ?? ""))
